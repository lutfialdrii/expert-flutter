...
import 'package:core/presentation/pages/tv_serie_detail_page.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.pushNamed(context, SEARCH_ROUTE, arguments: category);
            },
...
class ContentList extends StatelessWidget {
  ...
  ContentList({Key? key, required this.type, this.movies, this.tvSeries})
    : super(key: key);
